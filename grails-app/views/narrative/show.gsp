...
<html>
    ...
    <body>
        ...
        <div id="show-narrative" class="content scaffold-show" role="main">
            ...
            <f:display bean="narrative" />
            <g:form resource="${this.narrative}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.narrative}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
