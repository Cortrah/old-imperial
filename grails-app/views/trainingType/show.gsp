...
<html>
    ...
    <body>
        ...
        <div id="show-trainingType" class="content scaffold-show" role="main">
            ...
            <f:display bean="trainingType" />
            <g:form resource="${this.trainingType}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.trainingType}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
