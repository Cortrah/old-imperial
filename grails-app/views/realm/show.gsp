...
<html>
    ...
    <body>
        ...
        <div id="show-realm" class="content scaffold-show" role="main">
            ...
            <f:display bean="realm" />
            <g:form resource="${this.realm}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.realm}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
